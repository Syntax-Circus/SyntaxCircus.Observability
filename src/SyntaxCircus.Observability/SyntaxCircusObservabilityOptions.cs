...
public sealed class SyntaxCircusObservabilityOptions
{
    public OpenTelemetryOptions OpenTelemetry { get; init; } = new();

    public SentryOptions Sentry { get; init; } = new();

    public static SyntaxCircusObservabilityOptions FromConfiguration(IConfiguration configuration)
    {
        ...
        return new SyntaxCircusObservabilityOptions
        {
