...
public sealed class SyntaxCircusObservabilityRegistration
{
    private readonly string serviceName;
    private readonly string serviceVersion;
    private readonly string environment;

    private SyntaxCircusObservabilityRegistration(SyntaxCircusObservabilityOptions options, string serviceName, string serviceVersion, string environment)
    {
        Options = options;
    ...
    public SyntaxCircusObservabilityOptions Options { get; }

    public static SyntaxCircusObservabilityRegistration Register(
        ...
        IEnumerable<string>? meterNames = null)
    {
        ...
        var registration = new SyntaxCircusObservabilityRegistration(
            options,
            defaultServiceName,
        ...
        var openTelemetry = services.AddOpenTelemetry()
            .ConfigureResource(resource => resource
                .AddService(registration.serviceName, serviceVersion: registration.serviceVersion)
                .AddAttributes(new Dictionary<string, object>
                {
                    ["deployment.environment"] = registration.environment
                }));
    ...
    public void ConfigureSentry(SentryAspNetCoreOptions sentry, Func<TransactionSamplingContext, double?>? configureSampling = null)
    {
        ...
        sentry.TracesSampler = context => configureSampling?.Invoke(context)
